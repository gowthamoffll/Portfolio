...
const PROJECTS = [
  {
    ...
    category: 'Full Stack',
    year: '2024',
    description: 'A collaborative online code editor supporting multiple languages with real-time sync via WebSockets. Features include live cursor tracking, syntax highlighting, and integrated chat for pair programming sessions.',
    tech: ['React', 'Node.js', 'Socket.io', 'Monaco Editor', 'MongoDB'],
